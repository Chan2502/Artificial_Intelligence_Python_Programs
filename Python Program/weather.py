...
def getWeather():
    ...
    #whether
    api = "https://api.openweathermap.org/data/2.5/onecall?lat="+str(location.latitude)+"&lon="+str(location.longitude)+"&units=metric&exclude=hourly&appid=fe0c5871602c7e091affa1189a38cd60"
...
Label(frame, image=firstbox, bg="#ffffff").place(x=30, y=20)

Label(frame, image=secondbox, bg="#ffffff").place(x=300, y=30)
Label(frame, image=secondbox, bg="#ffffff").place(x=400, y=30)
Label(frame, image=secondbox, bg="#ffffff").place(x=500, y=30)
Label(frame, image=secondbox, bg="#ffffff").place(x=600, y=30)
Label(frame, image=secondbox, bg="#ffffff").place(x=700, y=30)
Label(frame, image=secondbox, bg="#ffffff").place(x=800, y=30)
...
#whether
api = "https://api.openweathermap.org/data/2.5/weather?lat={lat}&lon={lon}&appid={86f5689f3029f6db9ce8ec51b5887ad8}"
json_data = requests.get(api).json()
#current_data = json_data['current']
print(json_data)